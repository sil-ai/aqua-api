...
``/v4/assessments/{id}/…``, so the module is named for the agent family rather than for
today's parent path. The rest of that family is not carried to v4 — see
:mod:`agent_routes.v4` for which agent reads stayed on v3 and why.
