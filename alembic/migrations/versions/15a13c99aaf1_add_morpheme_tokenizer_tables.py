...
def upgrade() -> None:
    ...
    op.create_table('language_morphemes',
    ...
    sa.UniqueConstraint('iso_639_3', 'morpheme', name='uq_language_morphemes_iso_morpheme')
    )
    op.create_index('ix_language_morphemes_iso', 'language_morphemes', ['iso_639_3'], unique=False)
    op.create_index('ix_language_morphemes_iso_class', 'language_morphemes', ['iso_639_3', 'morpheme_class'], unique=False)
    op.create_table('tokenizer_runs',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('iso_639_3', sa.String(length=3), nullable=False),
    ...
    op.create_index('ix_tokenizer_runs_iso', 'tokenizer_runs', ['iso_639_3'], unique=False)
    op.create_index('ix_tokenizer_runs_revision', 'tokenizer_runs', ['revision_id'], unique=False)
