...
def upgrade() -> None:
    op.add_column('eflomal_assessment', sa.Column('src_bpe_model', sa.LargeBinary(), nullable=True))
    op.add_column('eflomal_assessment', sa.Column('tgt_bpe_model', sa.LargeBinary(), nullable=True))
    op.add_column('eflomal_assessment', sa.Column('bpe_priors', sa.Text(), nullable=True))
