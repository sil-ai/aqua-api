...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "artifact_version", sa.INTEGER(), autoincrement=False, nullable=False
        ),
        sa.Column("num_verse_pairs", sa.INTEGER(), autoincrement=False, nullable=True),
        sa.Column(
            "num_alignment_links", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "num_dictionary_entries", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "num_missing_words", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "created_at",
        ...
        sa.ForeignKeyConstraint(
            ["assessment_id"],
            ["assessment.id"],
            name="eflomal_model_assessment_id_fkey",
        ),
        sa.PrimaryKeyConstraint("id", name="eflomal_model_pkey"),
        sa.UniqueConstraint(
            "assessment_id",
            name="eflomal_model_assessment_id_key",
            postgresql_include=[],
