...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_eflomal_dictionary_assessment_source",
        "eflomal_dictionary",
        ["assessment_id", "source_word"],
        unique=False,
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ux_eflomal_dictionary_assessment_source_target",
        table_name="eflomal_dictionary",
    )
    op.drop_index(
        "ix_eflomal_dictionary_assessment_source", table_name="eflomal_dictionary"
    )
