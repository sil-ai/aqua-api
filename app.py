...
def configure_routing(app):
    app.include_router(language_router_v2)
    ...
    app.include_router(revision_router_v2)
    ...
    app.include_router(verse_router_v2)
    ...
    app.include_router(assessment_router_v2)
    ...
    app.include_router(results_router_v2)
